...
mv ${root_file_name}_chan${chan}-${file_suffix}.im /projects/vla-processing/GASKAP-HI/images/${sbid}/mw_velocities/${image_output_name}
mv ${root_file_name}_chan${chan}-beam.bm /projects/vla-processing/GASKAP-HI/images/${sbid}/mw_velocities/${beam_output_name}
